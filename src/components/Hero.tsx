...
export function Hero() {
  return <div className="fixed inset-0 min-h-screen overflow-hidden">
      {/* Enhanced Background */}
      ...
      <div className="fixed top-6 left-6 flex items-center gap-3 rounded-full glass-card border border-primary/20 group hover:border-primary/40 transition-all duration-500 z-50 px-4 py-2">
