...
const navigation = [
  ...
  { name: 'Write-ups', href: '/writeups', icon: FileText },
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 md:hidden bg-card p-2 rounded-lg shadow-medium border border-border"
      >
